...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "Update  subscription_plans set plan_duration='$duration', plan_price='$price'  where  plan_id='$aid'");
        if ($query) {
            echo "<script>alert('Subscription Plan updated.');</script>";
            echo "<script>document.location='./manage_subscription_plans.php'</script>";
        } else {
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <?php
                                    $aid = ($_GET['said']);
                                    $query = mysqli_query($con, "Select * from  subscription_plans where plan_id='$aid'");
                                    $cnt = 1;
