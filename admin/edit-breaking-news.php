                                ...
                                <div class="p-6">
                                    <div class="">
                                        <?php
                                              ...
                                              $query=mysqli_query($con,"select * from breaking_news where news_id='$news_id'");
                                        ...
                                        <form name="addpost" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="card-box">
                                                        ...
                                                        <?php echo htmlentities($row['news_desc'])  ?>
                                                        </textarea>
                                                    </div>
                                                    <div class="card-box">
                                                     </div>
                                            ...
                                            <div class="row m-b-30">
                                                <div class="col-sm-12">
                                                    <div class="card-box">
                                                        <h4 class="m-b-30 m-t-0 header-title"><b>Select State</b></h4>
                                                        <select name="state">
