...
CREATE TABLE `advertisement` (
  ...
  `validity` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
...
(23, '38a7166c1005a002fe282f97774a198e.jpg', 'sanjaythakor@gmail.com', 1, '2023-05-04 12:16:51', 1, 2400, 2, '2023-05-04 10:15:47', '2023-05-04 10:16:07', '2023-05-04 10:16:51');
...
--
-- Table structure for table `advertise_price`
--

CREATE TABLE `advertise_price` (
  `price` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

--
-- Dumping data for table `advertise_price`
--

INSERT INTO `advertise_price` (`price`) VALUES
(800);
...
--
ALTER TABLE `advertisement`
  MODIFY `advertise_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
